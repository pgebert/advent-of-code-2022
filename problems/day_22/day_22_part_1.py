...
def parse_input(line: str):
    ...
    return mode, x_lower, x_upper, y_lower, y_upper, z_lower, z_upper
...
def solve(input: List[str]):
    ...
    for line in input:
        active, x_lower, x_upper, y_lower, y_upper, z_lower, z_upper = parse_input(line)

        x_lower = max(x_lower, -50)
        x_upper = min(x_upper, 50)
        y_lower = max(y_lower, -50)
        y_upper = min(y_upper, 50)
        z_lower = max(z_lower, -50)
        z_upper = min(z_upper, 50)
